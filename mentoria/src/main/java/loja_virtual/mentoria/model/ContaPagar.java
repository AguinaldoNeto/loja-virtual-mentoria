...
import loja_virtual.mentoria.enums.StatusContaPagar;
...
@SequenceGenerator(name = "seq_tb_conta_pagar", sequenceName = "seq_tb_conta_pagar", allocationSize = 1, initialValue = 1)
public class ContaPagar implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_tb_conta_pagar")
    private Long id;
